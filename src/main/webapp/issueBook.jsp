  ...
  <body>
    ...
    <div class="container">
      ...
      <div class="header-area">
        ...
        <p>Enter details below to record a book loan.</p>
      </div>
      ...
      <main class="card">
        <form action="IssueBookServlet" method="post">
          <div class="form-group">
            ...
            <input type="number" name="bookid" id="bookId" placeholder="101" required />
          </div>

          <div class="form-group">
            <label for="rollNo">Student Roll No</label>
            <input type="text" name="rollno" id="rollNo" placeholder="e.g. T.24.99" required />
          </div>

          <button type="submit" class="submit-btn">
            <i data-lucide="book-open-check" size="18"></i>
            Issue Book
          </button>
        </form>
...
%>
 Student not available. Please register.
 
 <%
} if("books".equals(error)){
%>
Book not available.
<%
}
%>
      ...
      <section class="table-section">
        <h3>Available Books Inventory</h3>
         ...
         while(rs.next()){
            %>
              <tr>
                ...
                <td class="badge"><%=rs.getInt("quantity") %></td>
              </tr>
